...
entry = Entry(win, font=("Times", 18),width=80,fg = "black",borderwidth=8,bg = "lightgreen",relief = RAISED)
entry.pack(pady=10)
...
Create = Button(button_frame, text="Create Task", command=create_Tsk,borderwidth=12,font=("Times",14),width = 16, fg = "white",bg = "green", padx=10,pady=10,relief = RAISED)
Create.grid(row=0, column=0,padx=20)

Update = Button(button_frame, text="Update", command=up_Tsk,borderwidth=12,font=("Times",14),width = 16, fg = "white",bg = "blue", padx=10,pady=10,relief = RAISED)
Update.grid(row=0, column=1,padx=20)

Delete = Button(button_frame, text="Delete", command=del_Tsk,borderwidth=12,font=("Times",14),width = 16, fg = "white",bg = "red", padx=10,pady=10,relief = RAISED)
